 $(document).ready(function(){
  ...
  var imgsrc = "imags/blue0"+(qn+1)+".png";
 ...
 //loading the Questions
  ...
  $("#1,#change").click(function(){
    "use strict"
   var src = ($("#selectImg").attr('src') === 'imags/bluenm.png')?'imags/bluem.png':'imags/bluenm.png';
   $("#selectImg").attr('src' , src) ;
   if(src == "imags/bluenm.png"){
    questionAudio.play();
   }else{
    chooseAudio.pause();
    questionAudio.pause();
   ...
   $("#choose4").on('click' , ()=>{
     ...
     switch(qn){
      case 0:
       $(".q1").css("background-color", "#5FB6EF");
       $(".q1").css("color", "white");

      break;
      case 1:
       $(".q1").css("background-color", "#5FB6EF");
       $(".q2").css("background-color", "#5FB6EF");
       $(".q1").css("color", "white");
       $(".q2").css("color", "white");
      ...
      case 2:
       $(".q1").css("background-color", "#5FB6EF");
       $(".q2").css("background-color", "#5FB6EF");
       $(".q3").css("background-color", "#5FB6EF");
       $(".q1").css("color", "white");
       $(".q2").css("color", "white");
       $(".q3").css("color", "white");
      ...
      case 3:
       ...
       $(".q2").css("background-color", "#5FB6EF");
       $(".q3").css("background-color", "#5FB6EF");
       $(".q4").css("background-color", "#5FB6EF");
       $(".q1").css("color", "white");
       $(".q2").css("color", "white");
       $(".q3").css("color", "white");
       $(".q4").css("color", "white");
